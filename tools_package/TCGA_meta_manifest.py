...
def createManifestSlices(samples_file_metadata, samples_file_manifest, slice_size, output_name_root):
  ...
  for i in range(slices):
    ...
    df_manifest_sliced.to_csv(f"{slices_dir}/{output_name_root}-slice-{i}.txt", index=False)
...
samples_file_manifest = f"/content/{output_name_manifest}"
samples_file_metadata = f"/content/{output_name_meta}"
